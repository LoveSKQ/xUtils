...
public class Kill_Process {
    ...
    /**
     *杀死后台service而不自启动： am （Activity Manager）命令
     * 是Android系统中/system/bin/目录下的一条命令。不仅可以在终端下启动一个应用程序，还可以启动Service，发送 broadcast以及Intent action ，force stop process 等等，功能非常强大。这里我们要用到一个功能就是强制停止应用程序！
